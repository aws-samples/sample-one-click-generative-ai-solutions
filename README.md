...
[Spec-Driven Presentation Maker](https://github.com/aws-samples/sample-spec-driven-presentation-maker) は、仕様駆動開発のアプローチでプレゼンテーション資料を作成するオープンソースツールキットです。「何を伝えるか」を先に設計し、「どう見せるか」を AI が構築します。Kiro CLI スキルからフルスタック Web アプリまで、4 層アーキテクチャで必要なレイヤーだけ選んで使えます。
